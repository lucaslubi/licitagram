...
const FEATURES = [
  {
    title: 'Match Score com IA',
    description: 'Algoritmo de IA analisa cada licitação e calcula um score de compatibilidade personalizado para sua empresa.',
  },
  {
    title: 'Multi-Portal',
    description: 'Monitoramos PNCP, Compras.gov.br, BEC SP e portais estaduais. Todas as oportunidades em um só lugar.',
  },
  {
    title: 'Alertas via Telegram',
    description: 'Receba alertas instantâneos no Telegram quando uma licitação compatível é publicada.',
  },
  {
    title: 'Pipeline Kanban',
    description: 'Gerencie suas oportunidades com drag-and-drop: da descoberta até a proposta enviada.',
  },
  {
    title: 'Compliance Automático',
    description: 'Cruza os requisitos do edital com seus documentos cadastrados. Saiba se está apto antes de licitar.',
  },
  {
    title: 'Pergunte ao Edital',
    description: 'Chat com IA que responde perguntas sobre qualquer edital baseado no texto extraído dos documentos.',
  },
  {
    title: 'Inteligência Competitiva',
    description: 'Monitore concorrentes, veja histórico de participações e preços praticados.',
  },
  {
    title: 'Gestão de Certidões',
    description: 'Controle de validade de CND, FGTS, CNDT e outros documentos com alertas de vencimento.',
  },
]
    ...
    <div className="min-h-screen bg-[#FAFAF8]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36">
          <div className="max-w-3xl">
            ...
            <h1 className="text-display-lg sm:text-display-xl text-white mb-3 text-balance leading-[1.1]">
              Encontre as licitações certas{' '}
              <span className="text-[#F43E01]">para sua empresa.</span>
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl font-semibold tracking-wide mb-6 sm:mb-8">
              <span className="text-[#22C55E]">Brasil</span>
              <span className="text-white/50 mx-2">—</span>
              <span className="text-white">Gigante pela Própria </span>
              <span className="text-[#FACC15]">Natureza.</span>
            </p>
            <p className="text-body sm:text-body-lg text-[#9C9C90] mb-6 sm:mb-8 max-w-2xl leading-relaxed">
              O Licitagram monitora múltiplos portais de licitações, analisa cada edital com inteligência artificial e identifica as melhores oportunidades para o seu negócio. É a sua empresa, tornando o Brasil cada vez melhor.
            </p>
            ...
            <p className="mt-6 text-caption text-[#69695D]">Sem cartão de crédito. Cancele quando quiser.</p>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-black/[0.08] bg-[#F3F3EE]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 text-center">
            <div>
              <p className="text-heading-xl font-bold text-[#26292E]">3.200+</p>
              <p className="text-body-sm text-[#69695D] mt-1">Licitações monitoradas</p>
            </div>
            <div>
              <p className="text-heading-xl font-bold text-[#26292E]">4</p>
              <p className="text-body-sm text-[#69695D] mt-1">Portais integrados</p>
            </div>
            <div>
              <p className="text-heading-xl font-bold text-[#F43E01]">IA</p>
              <p className="text-body-sm text-[#69695D] mt-1">Análise automática</p>
            </div>
            <div>
              <p className="text-heading-xl font-bold text-[#26292E]">24/7</p>
              <p className="text-body-sm text-[#69695D] mt-1">Monitoramento contínuo</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 sm:py-28 bg-[#FAFAF8]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <p className="text-overline uppercase text-[#F43E01] tracking-widest mb-4">O problema</p>
          <h2 className="text-display-lg text-[#26292E] text-balance mb-6">
            Sua empresa perde licitações{' '}
            <span className="text-[#69695D]">por falta de informação.</span>
          </h2>
          <p className="text-body-lg text-[#69695D] max-w-2xl mx-auto leading-relaxed">
            Milhares de editais são publicados diariamente em dezenas de portais diferentes. Sem automação, é impossível monitorar tudo e encontrar as oportunidades certas a tempo.
          </p>
        </div>
      </section>
