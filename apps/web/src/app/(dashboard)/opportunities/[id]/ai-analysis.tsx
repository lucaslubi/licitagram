      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <div className="h-12 bg-white/[0.06] rounded animate-pulse" />
          </div>
        </CardContent>
      </Card>
    )
              ...
              return (
                <div className="flex flex-col sm:flex-row items-center gap-5 sm:gap-8">
                  ...
                  <div className="relative w-24 h-24 sm:w-28 sm:h-28 shrink-0">
                    ...
                    <div className="absolute inset-2.5 sm:inset-3 bg-[#131316] rounded-full flex items-center justify-center shadow-inner" title="Match direto entre sua empresa e os requisitos literais do edital (CNAE + palavras-chave + descrição)">
