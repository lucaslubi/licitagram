                ...
                <div className="p-3 min-w-[220px]">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className={`text-[9px] font-medium px-1 py-0.5 rounded ${
                      selectedMatch.matchSource === 'ai'
                        ? 'bg-blue-100 text-blue-700'
                        : 'bg-gray-100 text-gray-500'
                    }`}>
                      {selectedMatch.matchSource === 'ai' ? 'IA' : 'estimado'}
                    </span>
                      ...
                      <div className="flex flex-col items-center gap-0.5 flex-shrink-0">
                        <span
                          className={`inline-flex items-center justify-center w-9 h-9 rounded-full text-xs font-bold text-white ${
                            m.matchSource === 'ai' ? 'ring-2 ring-blue-400' : ''
                          }`}
                        ...
                        <span className={`text-[8px] font-medium ${
                          m.matchSource === 'ai' ? 'text-blue-600' : 'text-gray-400'
                        }`}>
                          {m.matchSource === 'ai' ? 'IA' : 'est.'}
                        </span>
                      </div>
